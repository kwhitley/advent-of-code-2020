...
dotted black bags contain no other bags.`.split('\n'),
  part2testRules: `shiny gold bags contain 2 dark red bags.
...
dark violet bags contain no other bags.`.split('\n'),
  actualRules: `light orange bags contain 1 dark maroon bag, 3 dim maroon bags, 5 striped green bags, 2 pale aqua bags.
...
pale lavender bags contain 5 wavy fuchsia bags, 5 wavy lavender bags.`.split('\n'),
}